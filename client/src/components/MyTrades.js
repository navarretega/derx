...
function MyTrades({ trades, activeToken }) {
  ...
  return (
    <div className="bg-gray-50 overflow-hidden shadow rounded-lg">
      <div className="bg-gray-100 text-center px-4 py-5 sm:px-6 tracking-wider">MY RECENT TRADES</div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {trades.slice(0, 5).map((trade) => {
                      if (trade.trader1 === accountAddress || trade.trader2 === accountAddress) {
                        return (
